    ...
    try {
      ...
      try {
        ...
        if (registrationData.name == null ||
            registrationData.name!.trim().isEmpty) {
          throw Exception(
        ...
        if (registrationData.gender == null ||
            registrationData.gender!.trim().isEmpty) {
          throw Exception(
        ...
        if (registrationData.intent == null ||
            registrationData.intent!.trim().isEmpty) {
          throw Exception(
        ...
        print(
          '📊 [DEBUG] name="${registrationData.name}", age=${registrationData.age}, gender=${registrationData.gender}, sports=${registrationData.sports}, intent=${registrationData.intent}',
        );
