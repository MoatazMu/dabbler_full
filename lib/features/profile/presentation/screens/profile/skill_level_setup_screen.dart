...
class SkillLevelSetupScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SkillLevelSetupScreen> createState() =>
      _SkillLevelSetupScreenState();
}
...
class _SkillLevelSetupScreenState extends ConsumerState<SkillLevelSetupScreen>
  ...
  void initState() {
    ...
    _skillScaleAnimation = Tween<double>(begin: 1.0, end: 1.1).animate(
      CurvedAnimation(
      ...
      [
        ...
        Row(
          children: [
            ...
            IconButton(
              onPressed: () =>
                  _addCertification(_certificationsController.text),
