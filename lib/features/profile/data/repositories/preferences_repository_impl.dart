...
class PreferencesRepositoryImpl implements PreferencesRepository {
  ...
  Future<Either<Failure, UserPreferences>> getPreferences(String userId) async {
    try {
      ...
      final localPreferences = await localDataSource.getLocalPreferences(
        userId,
      );
      ...
      return Left(
        NetworkFailure(
          message: 'No network and no local preferences: ${e.message}',
        ),
      );
    } catch (e) {
  ...
  Future<Either<Failure, UserPreferences>> updatePreferences(
    ...
    try {
      ...
      final validationErrors = await localDataSource.validatePreferences(
        preferencesModel,
      );
  ...
  Future<Either<Failure, UserPreferences>> updatePreferenceCategory(
    ...
    try {
      final updatedPreferences = await remoteDataSource
          .updatePreferenceCategory(userId, category, data);
      await localDataSource.saveLocalPreferences(userId, updatedPreferences);
      return Right(updatedPreferences.toEntity());
    } catch (e) {
      return Left(
        DataFailure(message: 'Failed to update preference category: $e'),
      );
    }
  }
    ...
    try {
      ...
      return preferencesResult.fold((failure) => Left(failure), (preferences) {
        final gamePrefs = {
          ...
          'preferred_team_size': preferences.preferredTeamSize
              .toString()
              .split('.')
              .last,
  ...
  Future<Either<Failure, Map<String, dynamic>>> updateGamePreferences(
    ...
    try {
      ...
      return Left(
        DataFailure(message: 'Failed to update game preferences: $e'),
      );
    }
  }
  ...
  Future<Either<Failure, List<String>>> addPreferredGameType(
    ...
    try {
      ...
      return Left(
        DataFailure(message: 'Failed to add preferred game type: $e'),
      );
    }
  }
  ...
  Future<Either<Failure, List<String>>> removePreferredGameType(
    ...
    try {
      ...
      return Left(
        DataFailure(message: 'Failed to remove preferred game type: $e'),
      );
    }
  }
  ...
  Future<Either<Failure, Map<String, dynamic>>> getLocationPreferences(
    ...
    try {
      ...
      return Left(
        DataFailure(message: 'Failed to get location preferences: $e'),
      );
    }
  }
  ...
  Future<Either<Failure, Map<String, dynamic>>> updateLocationPreferences(
    ...
    try {
      ...
      return Left(
        DataFailure(message: 'Failed to update location preferences: $e'),
      );
    }
  }
  ...
  Future<Either<Failure, List<String>>> removePreferredLocation(
    ...
    try {
      ...
      return Left(
        DataFailure(message: 'Failed to remove preferred location: $e'),
      );
    }
  }
  ...
  Future<Either<Failure, void>> updateMaxTravelDistance(
    ...
    try {
      if (distance < 0 || distance > 1000) {
        return const Left(
          ValidationFailure(
            message: 'Travel distance must be between 0 and 1000 km',
          ),
        );
      }
      ...
      return Left(
        DataFailure(message: 'Failed to update max travel distance: $e'),
      );
    }
  }
  ...
  Future<Either<Failure, Map<String, List<TimeSlot>>>> getAvailabilitySchedule(
    ...
    try {
      ...
      // Fetch from remote
      final remoteSchedule = await remoteDataSource.getAvailabilitySchedule(
        userId,
      );
      ...
      return Left(
        DataFailure(message: 'Failed to get availability schedule: $e'),
      );
    }
  }
  ...
  updateAvailabilitySchedule(
    ...
    try {
      ...
      try {
        // Update remote
        final updatedSchedule = await remoteDataSource
            .updateAvailabilitySchedule(userId, schedule);
      ...
      return Left(
        DataFailure(message: 'Failed to update availability schedule: $e'),
      );
    }
  }
  ...
  Future<Either<Failure, Map<String, List<TimeSlot>>>> updateDayAvailability(
    ...
    try {
      ...
      return scheduleResult.fold((failure) => Left(failure), (
        currentSchedule,
      ) async {
      ...
      return Left(
        DataFailure(message: 'Failed to update day availability: $e'),
      );
    }
  }
  ...
  Future<Either<Failure, Map<String, List<TimeSlot>>>> removeAvailabilitySlot(
    ...
    try {
      ...
      return Left(
        DataFailure(message: 'Failed to remove availability slot: $e'),
      );
    }
  }
  ...
  Future<Either<Failure, bool>> isAvailableAt(
    ...
    try {
      final isAvailable = await remoteDataSource.isAvailableAt(
        userId,
        dateTime,
      );
      ...
      final scheduleResult = await getAvailabilitySchedule(userId);
      return scheduleResult.fold((failure) => Left(failure), (schedule) {
  ...
  Future<Either<Failure, Map<String, dynamic>>> getSocialPreferences(
    ...
    try {
      ...
      return preferencesResult.fold((failure) => Left(failure), (preferences) {
        final socialPrefs = {
          'age_range_preference': preferences.ageRangePreference
              .toString()
              .split('.')
              .last,
          'gender_mix_preference': preferences.genderMixPreference
              .toString()
              .split('.')
              .last,
  ...
  Future<Either<Failure, Map<String, dynamic>>> updateSocialPreferences(
    ...
    try {
      ...
      return Left(
        DataFailure(message: 'Failed to update social preferences: $e'),
      );
    }
  }
  ...
  Future<Either<Failure, void>> updatePreferredAgeRanges(
    ...
    try {
      if (ageRanges.any((age) => age < 13 || age > 100)) {
        return const Left(
          ValidationFailure(message: 'Age ranges must be between 13 and 100'),
        );
      }
      ...
      return Left(
        DataFailure(message: 'Failed to update preferred age ranges: $e'),
      );
    }
  }
  ...
  Future<Either<Failure, void>> updateGenderPreference(
    ...
    try {
      if (preference != null &&
          !['any', 'male', 'female', 'non-binary'].contains(preference)) {
        return const Left(
          ValidationFailure(message: 'Invalid gender preference'),
        );
      }
      ...
      return Left(
        DataFailure(message: 'Failed to update gender preference: $e'),
      );
    }
  }
  ...
  Future<Either<Failure, UserPreferences>> getDefaultPreferencesTemplate({
    ...
    try {
      ...
      return Left(
        DataFailure(message: 'Failed to get default preferences template: $e'),
      );
    }
  }
  ...
  Future<Either<Failure, UserPreferences>> applyPreferencesTemplate(
    ...
    try {
      ...
      return Left(
        DataFailure(message: 'Failed to apply preferences template: $e'),
      );
    }
  }
  ...
  Future<Either<Failure, List<String>>> validatePreferences(
    ...
    try {
      final preferencesModel = UserPreferencesModel.fromEntity(preferences);
      final errors = await localDataSource.validatePreferences(
        preferencesModel,
      );
      return Right(errors);
    } catch (e) {
      return Left(
        ValidationFailure(message: 'Failed to validate preferences: $e'),
      );
    }
  }
  ...
  Future<Either<Failure, List<String>>> validateAvailabilitySchedule(
    ...
    try {
      ...
      return Left(
        ValidationFailure(
          message: 'Failed to validate availability schedule: $e',
        ),
      );
    }
  }
  ...
  Future<Either<Failure, Map<String, dynamic>>> getCompatibilityWith(
    ...
    try {
      final compatibility = await remoteDataSource.getCompatibilityWith(
        userId,
        otherUserId,
      );
  ...
  Future<Either<Failure, double>> calculateCompatibilityScore(
    ...
    try {
      final score = await remoteDataSource.calculateCompatibilityScore(
        userId,
        otherUserId,
      );
      return Right(score);
      ...
      return Left(
        DataFailure(message: 'Failed to calculate compatibility score: $e'),
      );
    }
  }
  ...
  Future<Either<Failure, void>> updateCompetitiveLevel(
    ...
    if (level < 1 || level > 10) {
      return const Left(
        ValidationFailure(
          message: 'Competitive level must be between 1 and 10',
        ),
      );
    }
    return _updateSinglePreference(
      userId,
      (prefs) => prefs.copyWith(preferCompetitive: level > 5),
    );
  }
  ...
  Future<Either<Failure, void>> updateSocialPreference(
    ...
    if (level < 1 || level > 10) {
      return const Left(
        ValidationFailure(
          message: 'Social preference must be between 1 and 10',
        ),
      );
    }
    return _updateSinglePreference(
      userId,
      (prefs) => prefs.copyWith(openToNewPlayers: level > 5),
    );
  }
  ...
  Future<Either<Failure, void>> updateAdvanceNoticeHours(
    ...
    if (hours < 0 || hours > 168) {
      ...
      return const Left(
        ValidationFailure(
          message: 'Advance notice must be between 0 and 168 hours',
        ),
      );
    }
    return _updateSinglePreference(
      userId,
      (prefs) => prefs.copyWith(minimumNoticeHours: hours),
    );
  }
  ...
  Future<Either<Failure, void>> setAutoAcceptInvitations(
    ...
    return _updateSinglePreference(
      userId,
      (prefs) => prefs.copyWith(autoAcceptInvites: enabled),
    );
  }
  ...
  UserPreferences _applyGamePreferenceUpdates(
    ...
    if (updates.containsKey('preferred_game_types')) {
      updated = updated.copyWith(
        preferredGameTypes: List<String>.from(updates['preferred_game_types']),
      );
    }
    if (updates.containsKey('prefer_competitive')) {
      updated = updated.copyWith(
        preferCompetitive: updates['prefer_competitive'],
      );
    }
  ...
  UserPreferences _applyLocationPreferenceUpdates(
    UserPreferences current,
    Map<String, dynamic> updates,
  ) {
    var updated = current;
    ...
    if (updates.containsKey('preferred_venues')) {
      updated = updated.copyWith(
        preferredVenues: List<String>.from(updates['preferred_venues']),
      );
    }
  ...
  UserPreferences _applySocialPreferenceUpdates(
    UserPreferences current,
    Map<String, dynamic> updates,
  ) {
    var updated = current;
  ...
  Future<Either<Failure, void>> _validateImportedData(
    Map<String, dynamic> data,
    String source,
  ) async {
  ...
  UserPreferences _convertImportedData(
    Map<String, dynamic> data,
    String source,
  ) {
