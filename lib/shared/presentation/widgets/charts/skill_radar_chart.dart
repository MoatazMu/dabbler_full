            ...
            child: GestureDetector(
              ...
              child: AnimatedBuilder(
                ...
                builder: (context, child) {
                  return CustomPaint(
                    size: Size(
                      widget.size - widget.padding.horizontal,
...
class _RadarChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final skillSet in skillSets) {
      ...
      final points = _calculateSkillPoints(
        skillSet,
        center,
        radius,
        skillCount,
  ...
  void _drawBackgroundRings(Canvas canvas, Offset center, double radius) {
    ...
    for (int i = 1; i <= scale.numberOfRings; i++) {
      ...
      if (scale.showLabels) {
        ...
        final labelText = labelValue.toStringAsFixed(
          labelValue == labelValue.toInt() ? 0 : 1,
        );
...
class SkillRadarPresets {
  ...
  static SkillRadarChart multiSportSkills({
    ...
    return SkillRadarChart(
      ...
      scale: const RadarScale(minValue: 0, maxValue: 10, numberOfRings: 5),
    );
  }
