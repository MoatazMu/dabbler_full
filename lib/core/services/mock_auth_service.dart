...
class MockAuthService {
  ...
  Future<void> sendPasswordResetEmail(String email) async {
    print(
      '📧 [MOCK] MockAuthService: Simulating password reset email to: $email',
    );
    ...
    // For mock purposes, we just simulate success
    print(
      '✅ [MOCK] MockAuthService: Password reset email sent successfully to: $email',
    );
  ...
  Future<bool> verifyOtp(String phoneNumber, String otp) async {
    print(
      '🔐 [MOCK] MockAuthService: Simulating OTP verification for: $phoneNumber with OTP: $otp',
    );
    ...
    if (isValid) {
      print(
        '✅ [MOCK] MockAuthService: OTP verification successful for: $phoneNumber',
      );
      return true;
    } else {
      print(
        '❌ [MOCK] MockAuthService: OTP verification failed for: $phoneNumber',
      );
