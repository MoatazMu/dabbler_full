...
extension ProfileStatisticsExtensions on ProfileStatistics {
  ...
  bool get isCurrentlyActive =>
      DateTime.now().difference(lastActive).inMinutes <= 30;
  ...
  List<String> get recommendations {
    ...
    if (improvementRate < 0) {
      suggestions.add(
        'Review your recent games to identify areas for improvement',
      );
    }

    if (mentorshipSessions == 0 && averageRating >= 3.5) {
      suggestions.add(
        'Consider mentoring newer players to give back to the community',
      );
    }
