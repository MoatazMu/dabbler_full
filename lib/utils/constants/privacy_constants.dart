...
class DataRetention {
  ...
  static const Duration inactiveAccountDeletion = Duration(days: 1095); // 3 years
...
class ConsentTypes {
  static const String essential = 'essential'; // Required for basic functionality
  ...
  static const String personalization = 'personalization'; // Content personalization
...
class PrivacyMessages {
  // Error messages
  static const String privacySettingUpdateFailed = 'Failed to update privacy setting';
  ...
  static const String accountDeletionFailed = 'Failed to process account deletion';
  static const String rateLimitExceeded = 'Too many requests. Please wait before trying again';
  static const String insufficientPermissions = 'Insufficient permissions for this action';
  
  // Success messages
  static const String privacySettingsUpdated = 'Privacy settings updated successfully';
  static const String dataExportRequested = 'Data export request submitted. You will receive an email when ready';
  static const String accountDeletionRequested = 'Account deletion requested. You have 30 days to cancel';
  static const String consentUpdated = 'Consent preferences updated';
  
  // Warning messages
  static const String publicProfileWarning = 'Making your profile public will allow anyone to see your information';
  static const String locationSharingWarning = 'Location sharing will show your approximate location to other users';
  static const String dataExportSizeWarning = 'Your data export may be large and take time to prepare';
  static const String accountDeletionWarning = 'Account deletion is permanent and cannot be undone after the grace period';
  
  // Information messages
  static const String gdprRightsInfo = 'You have rights under GDPR including access, rectification, and erasure of your data';
  static const String dataRetentionInfo = 'We retain different types of data for varying periods as outlined in our privacy policy';
  static const String consentWithdrawalInfo = 'You can withdraw consent at any time, though this may limit app functionality';
}
